<form action="{{ route('admin.settings.store') }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="form-group col-6">
            ...
            <input type="text" name="portal::default::header_image" value="@settings('portal::default::header_image', 'https://games.pay2wingaming.com/Images/Asset_2Game_BOY_2.png')" class="form-control">
        </div>
