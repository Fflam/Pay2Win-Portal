                    ...
                    <a href="" class="flex mr-6 xl:mr-8">
                        @if (Settings::has('logo'))
                            <img src="@settings('logo')" class="mr-3 h-8 rounded"
                                alt="@settings('app_name', 'Pay2WinGaming')" />
                        @endif
                        <span
    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="/" class="flex items-center">
                <img src="@settings('logo', 'https://games.pay2wingaming.com/Images/Asset_2Game_BOY_2.png')" class="mr-3 h-6 sm:h-9" alt="@settings('app_name', 'Pay2WinGaming')" />
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">@settings('app_name', 'Pay2WinGaming')</span>
            </a>
            @include(Theme::path('layouts.widgets.user-dropdown'))
