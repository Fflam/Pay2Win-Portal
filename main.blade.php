...
<head>
    <title>@settings('seo::title', 'Pay 2 Win Gaming')</title>
    <link rel="icon" href="@settings('favicon', 'https://games.pay2wingaming.com/Images/Asset_2Game_BOY_2.png')">
    ...
    <meta name="description" content="{{ $meta_description ?? settings('seo::description', 'Test site for game server hosting company Pay2WinGaming.com') }}">
    <meta name="theme-color" content="@settings('seo::color', '#4f46e5')">
    <meta name="keywords" content="{{ $meta_keywords ?? settings('seo::keywords', 'Game, Server, Rust, Satisfactory, Project Zomboid, PZ')}}">
    ...
    <meta property="og:title" content="@settings('seo::title', 'Pay2WinGaming')">
    ...
    <meta property="og:image" content="@settings('seo::image', 'https://games.pay2wingaming.com/Images/Asset_2Game_BOY_2.png')">
    ...
    <div class="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="place-self-center mr-auto lg:col-span-7">
            <h1 class="mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">
                @settings('portal::title', 'Dedicated Game Server Hosting!')
            </h1>
            <p class="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                @settings('portal::description', 'Start your game server today and be equiped for all situations with our high performance gear keeping your servers running 24/7')
            </p>
            <a href="#pricing"
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img
                src="@settings('portal::default::header_image', 'https://games.pay2wingaming.com/Images/Asset_2Game_BOY_2.png')"
                alt="{!! __('mockup') !!}">
        </div>
    </div>
</section>
...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <h2 class="mb-8 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 lg:mb-16 dark:text-white md:text-4xl">{!! __('client.host_favorite_games') !!}</h2>
        <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-3 dark:text-gray-400">
            <a href="#" class="flex justify-center items-center">
                <img src="https://licenses.wemx.net/img/services/rust.png" class="hover:text-gray-900 dark:hover:text-white"
                     style="height: 60px;"/>
                <h2 class="text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-3xl ml-4">{!! __('client.rust') !!}</h2>
            </a>

            <a href="#" class="flex justify-center items-center">
                <img src="https://licenses.wemx.net/img/services/minecraft.png" class="hover:text-gray-900 dark:hover:text-white"
                     style="height: 60px;"/>
                <h2 class="text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-3xl ml-4">{!! __('client.minecraft') !!}</h2>
            </a>

            <a href="#" class="flex justify-center items-center">
                <img src="https://licenses.wemx.net/img/services/ark.png" class="hover:text-gray-900 dark:hover:text-white"
                     style="height: 60px;"/>
                <h2 class="text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-3xl ml-4">{!! __('client.ack') !!}</h2>
            </a>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="mb-8 max-w-screen-md lg:mb-16">
            ...
            <p class="text-gray-500 sm:text-xl dark:text-gray-400">
                {!! __('client.our_game_anel_desc', ['app' => settings('app_name', 'Pay2WinGaming')]) !!}
            </p>
        </div>
        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center">
                    <img src="@settings('logo', 'https://games.pay2wingaming.com/Images/Asset_2Game_BOY_2.png')" class="mr-3 h-8"
                         alt="@settings('app_name', 'Pay2WinGaming') Logo"/>
                    <span
                        class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">@settings('app_name', 'Pay2WinGaming')</span>
                </a>
            </div>
